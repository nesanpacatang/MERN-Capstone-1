                ...
                <div>
                    ...
                    <div className='bg-light  flex flex-col justify-center px-10'>
                        ...
                        <div className='flex justify-center sm:x    items-center'>
                            ...
                            <p className='pl-4'>I confirm that I have read, understood, and accepted the Terms of Service .</p>
                        </div>
                        <div className='pt-10 pb-20 text-center'>
                            <NavLink to="/bookingconfirm"><button className='py-2 px-10 bg-button rounded-lg'>
                                Confirm
                            </button></NavLink>
                        </div>
