...
export const Home = () => {
  return (
    ...
    <div className="bg-shade">
      <div id="filter" className=" mx-auto md:w-11/12 lg:w-max   rounded-lg bg-cyan-600 z-40 relative bottom-16 sm:bottom-10 px-5 lg:px-1 xl:px-5 py-5">
      <form action="">
        ...
        {/* Pick-up Branch  */}
          <div className="flex justify-center items-center rounded-lg bg-white py-2 col-span-2 lg:col-span-1">
            <div className="relative ">
              <select className="rounded-lg pl-8 focus:ring-0 border-none" id="location" name="location" placeholder="Pick-up Branch">
                <option disabled value="Pick-up Branch"> Branch</option>
...
<div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 justify-center items-center text-white gap-2 mt-3">
  <div className="flex justify-center items-center gap-3 mr-8 md:mr-0">
    ...
    <p className="text-2xl md:text-xl xl:text-3xl">No Hidden Charges</p>
  </div>
  ...
  <div className="flex justify-center items-center gap-3 ml-1 md:ml-0">
    ...
    <p className="text-2xl md:text-xl xl:text-3xl">24/7 Customer Service</p>
  </div>
  ...
  <div className="flex justify-center items-center gap-3 mr-12 md:mr-0">
    ...
    <p className="text-2xl md:text-xl xl:text-3xl">FREE Cancellation</p>
  </div>
</div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 mt-5 gap-5 justify-center items-center">
      <div className="grid justify-center">
        <div className="bg-white rounded-full px-14">
          <img className="rounded-lg justify-center" src={maintain} alt="" />
        </div>
      ...
      <div className="container grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="text-center p-10 mt-10">
          <p className="text-center text-3xl sm:text-5xl mt-5 font-bold text-cyan-600">
            BOOK WITH US IN <br /> <span className="text-4xl sm:text-9xl">3</span> <br />
            EASY STEPS!
          </p>
      ...
      <div className=" container">
        ...
        <div className="">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div className="grid border border-solid border-white rounded-2xl" style={{ background: 'linear-gradient(1turn, #f1f6fd 30%, #edf1f7)', boxShadow: '3px 3px 9px rgba(164, 164, 186, 0.2)' }}>
            ...
            <div className="grid border border-solid border-white rounded-2xl" style={{ background: 'linear-gradient(1turn, #f1f6fd 30%, #edf1f7)', boxShadow: '3px 3px 9px rgba(164, 164, 186, 0.2)' }}>
              ...
              <div className="grid justify-between items-center p-5">
                ...
                <p className="text-xl">
                  Reliable, comfortable, fuel-efficient vehicles for business purposes,
                  with a range from compact sedans to luxury options.
                </p>
                <button className="mt-5 text-left">
                    <NavLink to="/business" className="bg-red-700 p-2 px-10 rounded-xl text-white font-semibold text-2xl">View Now</NavLink>
                </button>
              </div>
            </div>
          ...
          <div className="grid">
            <div className="grid border border-solid border-white rounded-2xl" style={{ background: 'linear-gradient(1turn, #f1f6fd 30%, #edf1f7)', boxShadow: '3px 3px 9px rgba(164, 164, 186, 0.2)' }}>
              ...
              <div className="grid justify-between items-center p-5">
                ...
                <button className="mt-5 text-left">
                  <NavLink to="pickup" className="bg-red-700 p-2 px-10 rounded-xl text-white font-semibold text-2xl">
                    View Now
                  </NavLink>
                </button>
              </div>
          ...
          <div className="grid">
            <div className="grid border border-solid border-white rounded-2xl" style={{ background: 'linear-gradient(1turn, #f1f6fd 30%, #edf1f7)', boxShadow: '3px 3px 9px rgba(164, 164, 186, 0.2)' }}>
              ...
              <div className="grid justify-between items-center p-5">
                ...
                <button className="mt-5 text-left">
                  <NavLink to="bridal" className="bg-red-700 p-2 px-10 rounded-xl text-white font-semibold text-2xl">
                    View Now
                  </NavLink>
                </button>
              </div>
            ...
            <div className="grid">
              <div className="grid border border-solid border-white rounded-2xl" style={{ background: 'linear-gradient(1turn, #f1f6fd 30%, #edf1f7)', boxShadow: '3px 3px 9px rgba(164, 164, 186, 0.2)' }}>
                ...
                <div className="grid justify-between items-center p-5">
                  ...
                  <p className="text-xl">
                    Larger vehicles with sleeping quarters, bathrooms, kitchens, and entertainment systems, providing comfortable accommodations for long-distance travel.
                  </p>
                  <button className="mt-5 text-left">
                    <NavLink to="family" className="bg-red-700 p-2 px-10 rounded-xl text-white font-semibold text-2xl">
                      View Now
                    </NavLink>
                  </button>
                </div>
          ...
          <div className="grid">
            <div className="grid border border-solid border-white rounded-2xl" style={{ background: 'linear-gradient(1turn, #f1f6fd 30%, #edf1f7)', boxShadow: '3px 3px 9px rgba(164, 164, 186, 0.2)' }}>
              ...
              <div className="grid justify-between items-center p-5">
                ...
                <p className="text-xl">
                  Practical, comfortable vehicles for everyday use, ranging from compact cars to SUVs, known for fuel efficiency and reliability.
                </p>
                <button className="mt-5 text-left">
                  <NavLink to="casual" className="bg-red-700 p-2 px-10 rounded-xl text-white font-semibold text-2xl">
                    View Now
                  </NavLink>
                </button>
              </div>
        ...
        </div>  {/* end of 1st row of car types*/}
